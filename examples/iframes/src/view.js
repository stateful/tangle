...
export default class View {
	...
	constructor(template) {
        ...
        this.$lastUpdatedBy = qs('#lastUpdatedBy');

        const $heading = qs('header h1');
        ...
        window.tangle.on('lastUpdatedBy', this.lastUpdatedBy.bind(this));
	}

    /**
     * Update last update note
     *
     * @param {!String} id iFrame identifier that last updated the todos
     */
    lastUpdatedBy(id) {
        this.$lastUpdatedBy.innerHTML = `Last Updated By: ${id}`;
    }
